...
INPUT_PATH=inputs/reproducibility/TEMPLATE_B1_saCeSS.xml
OUTPUT_PATH=output/B1_SACESS_6_MPI_4_OMP
NUM_PROC=11 # NUMBRE OF MPI PARALLEL PROCESSORS
OMP_NUM_THREADS=4 # NUMBER OF OPENMP THREAD PER MPI PROCESSOR
