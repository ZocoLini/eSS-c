...
INPUT_PATH=inputs/reproducibility/TEMPLATE_B4_saCeSS.xml
OUTPUT_PATH=output/B4_SACESS_6_MPI_8_OMP
NUM_PROC=6 # NUMBRE OF MPI PARALLEL PROCESSORS
OMP_NUM_THREADS=8 # NUMBER OF OPENMP THREAD PER MPI PROCESSOR
