...
int calcramigo_(int *n, int *p, double *x, int *nf, double *r__,
        int *lty, double *ty, AMIGO_problem *amigo_problem, int *stop, int *NPROC) {
...
int calcjamigo_(int *n, int* p, double *x, int *nf, double *dr__, int *lty, double *ty, AMIGO_problem *amigo_problem, int *stop, int *NPROC) {
